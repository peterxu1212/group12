    ...
    for str_file_name in in_file_name_list:
        ...
        try:
            ...
            if not b_test:
                ...
                pre_processed_item['text_wo_html_tags'] = file_content_wo_html_tags
                
                pre_processed_item['text_simple_cleanup'] = " ".join(review_to_wordlist(file_content_wo_html_tags, remove_stopwords=True))
                
                pre_processed_item['text_letter_and_num'] = " ".join(extract_features(file_content_wo_html_tags))
                ...
                pre_processed_item['simplified_cleanup'] = uni_code_converted
